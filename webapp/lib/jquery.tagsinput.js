			...
			if (settings.interactive) { 
				...
				if (settings.autocomplete_url != undefined) {
					...
					if (jQuery.Autocompleter !== undefined) {
						...
						// if a variable tabs out of the field, create a new tag
				...
				// if variable types a comma, create a new tag
				...
				//Removes the not_valid class when variable changes the value of the fake input
				if(data.unique) {
